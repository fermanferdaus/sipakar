			...
			<div class="col-md-12">
				<div class="card">
					...
					<form method="post" action="simpan-surat.php">
						...
						<br>
						<h6 class="container-fluid" align="right"><i class="fas fa-edit"></i> Formulir Usaha</h6><hr width="97%">
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									<label class="col-sm-12" style="font-weight: 500;">Jumlah Usaha</label>
									<div class="col-sm-12">
								...
								<!-- Form tambahan jenis usaha akan muncul di sini -->
								<div class="col-sm-12" id="form-usaha-dinamis"></div>
							</div>
						</div>
						<script>
							...
							for (let i = 1; i <= jumlah; i++) {
								...
								div.innerHTML = `
								<label style="font-weight: 500;">Usaha ${i}</label>
								<input type="text" name="fjenis_usaha_${i}" class="form-control" placeholder="Masukkan jenis usaha ke-${i}" required>
								`;
