			...
			<div class="col-md-12">
				<div class="card">
					...
					<form method="post" action="simpan-surat.php">
						...
						<br>
						<h6 class="container-fluid" align="right"><i class="fas fa-edit"></i> Formulir Informasi Kehilangan</h6><hr width="97%">
						<div class="row">
							<div class="col-sm-6">
						      	<div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Barang Hilang</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fbarang_hilang" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Barang yang hilang" required>
						           	</div>
						        </div>
						  	</div>
						  	<div class="col-sm-6">
						      	<div class="form-group">
						           	...
						           	<div class="col-sm-12">
						               	<input type="text" name="fhari" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Hari" required>
						           	</div>
						        </div>
						    </div>
						  	<div class="col-sm-6">
						  	...
						  	<div class="col-sm-6">
								<div class="form-group">
										<label class="col-sm-12" style="font-weight: 500;">Jam Kehilangan</label>
										<div class="col-sm-12">
						  	...
						  	<div class="col-sm-6">
						      	<div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Tempat Kehilangan</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="ftempat_kehilangan" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan tempat kehilangan" required>
						           	</div>
						        </div>
						  	</div>
						</div>
