					...
					<div class="col-md-12">
						<div class="card">
							...
							<form method="post" action="simpan-surat.php">
								...
								<br>
								<h6 class="container-fluid" align="right"><i class="fas fa-edit"></i> Formulir Penerima Kuasa
								</h6>
								<hr width="97%">
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="col-sm-12">
												<input type="text" name="fnama_k" class="form-control"
													style="text-transform: capitalize;" placeholder="Masukkan nama kuasa"
													required>
											</div>
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group">
											<label class="col-sm-12" style="font-weight: 500;">Alamat Tinggal</label>
											<div class="col-sm-12">
												<input type="text" name="falamat_k" class="form-control" placeholder="Masukkan Alamat"
													required>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="form-group">
											<label class="col-sm-12" style="font-weight: 500;">Kondisi Pihak I</label>
											<div class="col-sm-12">
												<input type="text" name="fkondisi_pihak1" class="form-control"
													style="text-transform: capitalize;" placeholder="Masukkan kondisi pihak I" required>
											</div>
										</div>
									</div>
									<div class="col-sm-12">
										<div class="form-group">
											<label class="col-sm-12" style="font-weight: 500;">Keterangan Kuasa Pihak II</label>
											<div class="col-sm-12">
												<input type="text" name="fkuasa_pihak2" class="form-control"
													style="text-transform: capitalize;" placeholder="Masukkan keterangan kuasa pihak II" required>
											</div>
										</div>
									</div>
								</div>
