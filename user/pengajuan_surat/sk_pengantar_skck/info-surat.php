					...
					<div class="col-md-12">
						<div class="box box-info">
							<div class="box-header with-border">
								<h3 class="box-title"><i class="fas fa-envelope"></i> FORMULIR PENGANTAR SKCK</h3>
							</div>
							...
							<form class="form-horizontal" method="post" action="simpan-surat.php">
								<div class="box-body">
									...
									<hr>
									<h4><b>Formulir Surat</b></h4>
									<hr>

									<div class="form-group">
										<label class="col-sm-2 control-label">Keperluan Surat</label>
										<div class="col-sm-10">
