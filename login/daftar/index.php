            ...
            <div class="col-md-6 col-lg-5">
                <div class="card p-4">
                    <div class="card-header text-center">
                        <h3 class="text-info">Daftar Akun SIPAKAR</h3>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="aksi-daftar.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group" id="show_hide_konfirmasi">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-lock"></i></span>
                                    </div>
                            ...
                            <button type="submit" class="btn login_btn btn-block mt-3">Daftar</button>
                            <a href="../" class="btn login_btn btn-block mt-2">Login</a>
                        </form>
                    </div>
