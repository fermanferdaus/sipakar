   		...
   		<div class="row">
      		...
      		<div class="box-body">
                  ...
                  <div class="col-md-4" style="text-align: center;">
                    <img style="max-width:300px; width:100%; height:auto;" src="../../assets/img/logo-lampura.png"><br>
                    <?php  
                  ...
                  <div class="col-md-8">
                    ...
                    <div style="font-size: 20pt; font-weight: 500;"><p>Selamat datang di <a href="#" style="text-decoration:none"><br><strong>Sistem Informasi Pelayanan Administrasi Surat Desa Pagar.</strong></a></p></div>
                  </div>
        				</div>
              </form>
        		</div>
