<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect, "SELECT penduduk.*, sk_ahli_waris.* FROM penduduk LEFT JOIN sk_ahli_waris ON sk_ahli_waris.nik = penduduk.nik WHERE sk_ahli_waris.id_aw = '$id'");
      ...
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Keterangan Ahli Waris</h2>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_aw']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Status Kuasa</label>
                      <div class="col-sm-9">
                        <input type="text" name="fstatus_kuasa" style="text-transform: uppercase;" value="<?php echo $row['status_kuasa']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
              </div>
              <h5 class="box-title pull-right" style="color: #696969;"><i class="fas fa-info-circle"></i> <b>Informasi Ahli Waris</b></h5>
              <br><hr style="border-bottom: 1px solid #DCDCDC;">
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fnama_aw" style="text-transform: capitalize;" value="<?php echo $row['nama_aw']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Tempat, Tgl Lahir</label>
                      <div class="col-sm-9">
                        <input type="text" name="ftgl_lahir_aw" style="text-transform: capitalize;" value="<?php echo $row['tempat_lahir_aw']. ", " . $tgl . $blnIndo[$bln] . $thn; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Pekerjaan</label>
                      <div class="col-sm-9">
                        <input type="text" name="fpekerjaan" style="text-transform: capitalize;" value="<?php echo $row['pekerjaan_aw']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fstatus_aw" style="text-transform: capitalize;" value="<?php echo $row['status_aw']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Alamat</label>
                      <div class="col-sm-9">
                        <textarea rows="3" name="falamat" class="form-control" style="text-transform: capitalize;" readonly><?php echo $row['jalan_aw'] . ", RT" . $row['rt_aw'] . "/RW" . $row['rw_aw'] . ", Dusun " . $row['dusun_aw'] . ", Desa " . $row['desa_aw'] . ", Kecamatan " . $row['kecamatan_aw'] . ", " . $row['kabupaten_aw'];  ?></textarea>
                      </div>
                    </div>
                  </div>
