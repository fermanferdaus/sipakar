                  ...
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="fnama_tm" style="text-transform: capitalize;"
                            value="<?php echo $row['nama_tm']; ?>" class="form-control" readonly>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        <label class="col-sm-3 control-label">Tempat, Tgl Lahir</label>
                        <div class="col-sm-9">
                          <input type="text" name="ftgl_lahir_tm" style="text-transform: capitalize;"
                            value="<?php echo $row['tempat_lahir_tm'] . ", " . $tgl . $blnIndo[$bln] . $thn; ?>"
                            class="form-control" readonly>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="fpekerjaan" style="text-transform: capitalize;"
                            value="<?php echo $row['pekerjaan_tm']; ?>" class="form-control" readonly>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        <label class="col-sm-3 control-label">Agama</label>
                        <div class="col-sm-9">
                          <input type="text" name="fagama_tm" style="text-transform: capitalize;"
                            value="<?php echo $row['agama_tm']; ?>" class="form-control" readonly>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <textarea rows="3" name="falamat" class="form-control" style="text-transform: capitalize;"
                            readonly><?php echo $row['jalan_tm'] . ", RT" . $row['rt_tm'] . "/RW" . $row['rw_tm'] . ", Dusun " . $row['dusun_tm'] . ", Desa " . $row['desa_tm'] . ", Kecamatan " . $row['kecamatan_tm'] . ", " . $row['kabupaten_tm']; ?></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
