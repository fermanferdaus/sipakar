<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect, "SELECT penduduk.*, sk_tidak_mampu.* FROM penduduk LEFT JOIN sk_tidak_mampu ON sk_tidak_mampu.nik = penduduk.nik WHERE sk_tidak_mampu.id_tm = '$id'");
      ...
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Tidak Mampu</h2>
          ...
          <div class="box-body">
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_tm']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
              ...
              <h5 class="box-title pull-right" style="color: #696969;"><i class="fas fa-info-circle"></i> <b>Informasi Identitas Anak</b></h5>
              <br><hr style="border-bottom: 1px solid #DCDCDC;">
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fnama_tm" style="text-transform: capitalize;" value="<?php echo $row['nama_tm']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Tempat, Tgl Lahir</label>
                      <div class="col-sm-9">
                        <input type="text" name="ftgl_lahir_tm" style="text-transform: capitalize;" value="<?php echo $row['tempat_lahir_tm']. ", " . $tgl . $blnIndo[$bln] . $thn; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Pekerjaan</label>
                      <div class="col-sm-9">
                        <input type="text" name="fpekerjaan" style="text-transform: capitalize;" value="<?php echo $row['pekerjaan_tm']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Agama</label>
                      <div class="col-sm-9">
                        <input type="text" name="fagama_tm" style="text-transform: capitalize;" value="<?php echo $row['agama_tm']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Alamat</label>
                      <div class="col-sm-9">
                        <textarea rows="3" name="falamat" class="form-control" style="text-transform: capitalize;" readonly><?php echo $row['jalan_tm'] . ", RT" . $row['rt_tm'] . "/RW" . $row['rw_tm'] . ", Dusun " . $row['dusun_tm'] . ", Desa " . $row['desa_tm'] . ", Kecamatan " . $row['kecamatan_tm'] . ", " . $row['kabupaten_tm'];  ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
