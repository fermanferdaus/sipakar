                  ...
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="fnama_pot" style="text-transform: uppercase;"
                            value="<?php echo $row['nama_pot']; ?>" class="form-control" readonly>
                        </div>
                      </div>
                      <?php
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="ft_lahir" style="text-transform: capitalize;"
                            value="<?php echo $row['tempat_lahir_pot'] . ", " . $tgl . $blnIndo[$bln] . $thn; ?>"
                            class="form-control" readonly>
                        </div>
                      </div>
                      <div>
                  ...
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="fprodi" style="text-transform: capitalize;"
                            value="<?php echo $row['prodi']; ?>" class="form-control" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-3 control-label">Keperluan</label>
                        <div class="col-sm-9">
                          <input type="text" name="fkeperluan" style="text-transform: capitalize;"
                            value="<?php echo $row['keperluan']; ?>" class="form-control" readonly>
                        </div>
                      </div>
                    </div>
