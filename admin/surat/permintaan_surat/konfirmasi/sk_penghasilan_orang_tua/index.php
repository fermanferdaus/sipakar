<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect,"SELECT penduduk.*, sk_penghasilan_orang_tua.* 
  FROM penduduk 
  LEFT JOIN 
  sk_penghasilan_orang_tua 
  ON 
  sk_penghasilan_orang_tua.nik = penduduk.nik 
  WHERE 
  sk_penghasilan_orang_tua.id_pot='$id'
  ");
      ...
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Penghasilan Orang Tua</h2>
          ...
          <div class="box-body">
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <h5 class="box-title pull-right" style="color: #696969;"><i class="fas fa-info-circle"></i> <b>Informasi Identitas</b></h5>
              <br><hr style="border-bottom: 1px solid #DCDCDC;">
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fnama_pot" style="text-transform: uppercase;" value="<?php echo $row['nama_pot']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <?php
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Tempat, Tgl Lahir</label>
                      <div class="col-sm-9">
                        <input type="text" name="ft_lahir" style="text-transform: capitalize;" value="<?php echo $row['tempat_lahir_pot'] . ", " . $tgl . $blnIndo[$bln] . $thn; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_pot']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fprodi" style="text-transform: capitalize;" value="<?php echo $row['prodi']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
