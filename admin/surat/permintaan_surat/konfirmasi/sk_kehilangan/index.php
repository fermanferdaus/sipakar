                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="ftempat_kehilangan" style="text-transform: capitalize;" value="<?php echo $row['tempat_kehilangan']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="ftanggal_kehilangan" style="text-transform: capitalize;" value="<?php echo $tgl . $blnIndo[$bln] . $thn; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Waktu</label>
                      <div class="col-sm-9">
                        <input type="text" name="fwaktu_kehilangan" value="<?php echo date('H:i', strtotime($row['jam_kehilangan'])); ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
