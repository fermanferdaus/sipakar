        ...
        <div class="col-md-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Kuasa</h2>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="box-body">
                      ...
                      <div>
                        <input type="hidden" name="id" value="<?php echo $row['id_kuasa']; ?>" class="form-control">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="fnama_k" style="text-transform: capitalize;"
                            value="<?php echo $row['nama_kuasa']; ?>" class="form-control" readonly>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        <label class="col-sm-3 control-label">Jenis Kelamin</label>
                        <div class="col-sm-9">
                          <input type="text" name="fj_kelamin_k" style="text-transform: capitalize;"
                            value="<?php echo $row['jenis_kelamin_kuasa']; ?>" class="form-control" readonly>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        <label class="col-sm-3 control-label">Alamat</label>
                        <div class="col-sm-9">
                          <textarea rows="3" name="falamat_k" class="form-control" style="text-transform: capitalize;"
                            readonly><?php echo $row['alamat_kuasa']; ?></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
