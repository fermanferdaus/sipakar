        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                   ...
                   <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_u']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
              ...
              <h5 class="box-title pull-right" style="color: #696969;"><i class="fas fa-info-circle"></i> <b>Informasi Usaha</b></h5>
              <br><hr style="border-bottom: 1px solid #DCDCDC;">
              <div class="row">
                <div class="col-md-12">
                  <div class="box-body">
                    <?php
                      $jumlah_usaha = intval($row['jumlah_usaha']);
                    ?>

                    <!-- Jumlah Usaha -->
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Jumlah Usaha</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" value="<?php echo $jumlah_usaha; ?>" readonly>
                      </div>
                    </div>

                    <!-- Daftar Jenis Usaha -->
                    <?php
                      for ($i = 1; $i <= $jumlah_usaha; $i++) {
                        $jenis = isset($row["jenis_usaha_$i"]) ? $row["jenis_usaha_$i"] : '';
                        echo '
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Jenis Usaha ' . $i . '</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" style="text-transform: capitalize;" value="' . htmlspecialchars($jenis) . '" readonly>
                          </div>
                        </div>';
                      }
                    ?>
