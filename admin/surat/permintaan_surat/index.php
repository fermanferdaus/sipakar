        ...
        <table class="table table-striped table-bordered table-responsive" id="data-table" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            $qTampil = mysqli_query($connect, "SELECT penduduk.nama, sk_kehilangan.id_kh AS id, sk_kehilangan.no_surat, sk_kehilangan.nik, sk_kehilangan.jenis_surat, sk_kehilangan.status_surat, sk_kehilangan.tanggal_surat FROM sk_kehilangan LEFT JOIN penduduk ON sk_kehilangan.nik = penduduk.nik WHERE sk_kehilangan.status_surat = 'pending' 
                ...
                UNION SELECT penduduk.nama, sk_tidak_mampu.id_tm AS id, sk_tidak_mampu.no_surat, sk_tidak_mampu.nik, sk_tidak_mampu.jenis_surat, sk_tidak_mampu.status_surat, sk_tidak_mampu.tanggal_surat FROM penduduk LEFT JOIN sk_tidak_mampu ON sk_tidak_mampu.nik = penduduk.nik WHERE sk_tidak_mampu.status_surat = 'pending'
                UNION SELECT penduduk.nama, sk_penghasilan_orang_tua.id_pot AS id, sk_penghasilan_orang_tua.no_surat, sk_penghasilan_orang_tua.nik, sk_penghasilan_orang_tua.jenis_surat, sk_penghasilan_orang_tua.status_surat, sk_penghasilan_orang_tua.tanggal_surat FROM sk_penghasilan_orang_tua LEFT JOIN penduduk ON sk_penghasilan_orang_tua.nik = penduduk.nik WHERE sk_penghasilan_orang_tua.status_surat = 'pending'
                UNION SELECT penduduk.nama, sk_pengantar_skck.id_sps AS id, sk_pengantar_skck.no_surat, sk_pengantar_skck.nik, sk_pengantar_skck.jenis_surat, sk_pengantar_skck.status_surat, sk_pengantar_skck.tanggal_surat FROM sk_pengantar_skck LEFT JOIN penduduk ON sk_pengantar_skck.nik = penduduk.nik WHERE sk_pengantar_skck.status_surat = 'pending'
                UNION SELECT penduduk.nama, sk_usaha.id_u AS id, sk_usaha.no_surat, sk_usaha.nik, sk_usaha.jenis_surat, sk_usaha.status_surat, sk_usaha.tanggal_surat FROM sk_usaha LEFT JOIN penduduk ON sk_usaha.nik = penduduk.nik WHERE sk_usaha.status_surat = 'pending'
