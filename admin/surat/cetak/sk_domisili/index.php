...
<div>
	...
	<div id="isi3">
		<table width="100%">
			<tr>
				<td>Yang bertanda tangan dibawah ini Kepala Desa <?php echo strtoupper($rows['nama_desa']); ?> Kecamatan <?php echo $rows['kecamatan']; ?> Kabupaten <?php echo $rows['kota']; ?>, Menerangkan bahwa tersebut dibawah ini :
				</td>
			</tr>
		</table>
		<br>
		...
		<table width="100%">
			<tr>
				<td> Orang tersebut diatas adalah benar Penduduk Desa <?php echo strtoupper($rows['nama_desa']); ?> Terdaftar dalam Buku Induk Kependudukan Desa <?php echo strtoupper($rows['nama_desa']); ?> Kecamatan <?php echo $rows['kecamatan']; ?> dan BENAR di alamat tersebut.</td>
			</tr>
			<tr>
				<td> Surat ini dimohonkan oleh yang bersangkutan guna pengganti Kartu Tanda Penduduk (KTP- el) masih dalam Proses CAPIL.</td>
			</tr>
		</table>
		<br>
		<table width="100%">
			<tr>
				<td>Demikian surat Keterangan Berdomisili ini dibuat dengan sebenarnya untuk dapat dipergunakan sebagaimana mestinya bagi yang berkepentingan, dan terima kasih.</td>
			</tr>
		</table>
	</div>
	<br>
