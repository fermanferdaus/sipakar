                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="frt" class="form-control" placeholder="Masukkan RT" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="frw" class="form-control" placeholder="Masukkan RW" required>
                      </div>
                    </div>
                    <div class="form-group">
