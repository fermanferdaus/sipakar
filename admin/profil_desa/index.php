...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Kelola Profil Desa</li>
    </ol>
  </section>
          ...
          <table class="table table-striped table-bordered" id="data-table" width="100%" cellspacing="0">
            <thead>
              <tr>
                ...
                <th style="width: 500px;"><strong>Deskripsi</strong></th>
                <?php
                if (isset($_SESSION['lvl']) && ($_SESSION['lvl'] == 'Administrator')) {
                  ?>
                  <th style="width: 30px; text-align: center;"><strong>Aksi</strong></th>
                <?php } ?>
              </tr>
            </thead>
            <tbody>
              ...
              $no = 1;
              $qTampil = mysqli_query($connect, "SELECT * FROM profil_desa");
              foreach ($qTampil as $row) {
                ?>
                <tr>
                  <td style="width: 160px; text-align: center;">
                    <img src="../../assets/img/<?php echo $row['gambar_desa']; ?>" style="max-width: 200px; height: auto;"
                      class="img-thumbnail">
                  </td>
                  <td style="text-transform: none;"><?php echo $row['deskripsi']; ?></td>
                  <?php
                  if (isset($_SESSION['lvl']) && ($_SESSION['lvl'] == 'Administrator')) {
                    ?>
                    <td style="text-align: center;">
                      <a class="btn btn-success btn-sm"
                        href='edit-profil-desa.php?id=<?php echo $row['id_profil_desa']; ?>'><i class="fa fa-edit"></i></a>
                    </td>
                  <?php } ?>
                </tr>
              <?php } ?>
