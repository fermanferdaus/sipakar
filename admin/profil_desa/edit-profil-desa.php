...
$id = $_GET['id'];
$qCek = mysqli_query($connect, "SELECT * FROM profil_desa WHERE id_profil_desa='$id'");
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active">
          <a href="index.php"><i class="fa fa-cogs"></i> <span>Kelola Profil Desa</span></a>
        </li>
        <?php
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Profil Desa</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-default">
            ...
            <div class="box-body">
              <form class="form-horizontal" method="post" action="update-profil-desa.php" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?= $row['id_profil_desa']; ?>">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Gambar Sekarang</label>
                  <div class="col-sm-10">
                    <?php if ($row['gambar_desa'] != '') { ?>
                      <img src="../../assets/img/<?= $row['gambar_desa']; ?>" style="max-height:150px;">
                    <?php } else { ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="hidden" name="gambar_lama" value="<?= $row['gambar_desa']; ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="fdeskripsi" class="form-control" rows="5"
