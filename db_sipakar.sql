...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2025 at 03:57 PM
...
(1, 'ADI SOPYAN', 'Kepala Desa'),
(2, 'MASYHUR KUMAR', 'Pj Kepala Desa'),
(3, 'CHIKO DASMIRA', 'Bendahara'),
(4, 'DONNY ALENDRA', 'OPERATOR SISK-NG'),
(5, 'RINI SAFITRI', 'OPERATOR SISKUEDES');
...
(1, 'pagar', 'Jln. Lintas Sumatera, Kecamatan Blambangan Pagar, Kabupaten Lampung Utara, Provinsi Lampung.', '082330827777', 'Blambangan Pagar', 'kabupaten Lampung Utara', 'Lampung', '34161 ');
...
--
ALTER TABLE `pejabat_desa`
  MODIFY `id_pejabat_desa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `sk_ahli_waris`
  MODIFY `id_aw` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `sk_jual_beli`
  MODIFY `id_jb` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `sk_kuasa`
  MODIFY `id_kuasa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `sk_penghasilan_orang_tua`
  MODIFY `id_pot` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `sk_tidak_mampu`
--
ALTER TABLE `sk_tidak_mampu`
  MODIFY `id_tm` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `surat_keterangan_domisili`
  MODIFY `id_skd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
